  ...
  return (
    <>
      <div className="flex border-b  items-center justify-between px-6 py-4 mb-10">
        ...
        <div>
          {/* button conditonally rendered */}
          {location.pathname !== "/publish" && (
            <Link to={"/publish"}>
              <button
                type="button"
                className="text-white bg-green-600 hover:bg-green-800 focus:outline-none focus:ring-4 mr-6 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
              >
                Publish
              </button>
            </Link>
